  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 bg-darkcard border border-dark-border hover:border-brand-500/50 rounded-3xl p-8 sm:p-10 flex flex-col justify-between transition-all duration-300 group">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xl">
              Process milions of event triggers concurrently with low-latency
        ...
        <div className="bg-darkcard border border-dark-border hover:border-brand-500/50 rounded-3xl p-8 sm:p-10 flex flex-col justify-between transition-all duration-300 group">
          <div>
            <div className="w-12 h-12 rounded-2xl bg-brand-500/10 border border-brand-500/20 text-brand-accent flex items-center justify-center text-2xl font-bold mb-6 group-hover:scale-110 transition-transform">
              🛡️
            </div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xl">
              Automated token rotation, encrypted data vaullts, and role-based
        ...
        <div className="bg-darkcard border border-dark-border hover:border-brand-500/50 rounded-3xl p-8 sm:p-10 flex flex-col justify-between transition-all duration-300 group">
          <div>
            <div className="w-12 h-12 rounded-2xl bg-emerald-500/10 border border-brand-500/20 text-brand-accent flex items-center justify-center text-2xl font-bold mb-6 group-hover:scale-110 transition-transform">
              🌐
            </div>
            <h3 className="text-2xl font-bold text-white mb-3">
              Edge CDN Routing
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xl">
              Global content delievery network caching static assets and dynamic
              responces at 250+ edge node
            </p>
          </div>
        ...
        <div className="md:col-span-2 bg-darkcard border border-dark-border hover:border-brand-500/50 rounded-3xl p-8 sm:p-10 flex flex-col justify-between transition-all duration-300 group">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xl">
              Inspect application metrics, memory fotprints, active database
