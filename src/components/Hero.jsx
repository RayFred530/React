const Hero = () => {
  return (
    <section className="relative pt-36 pb-20 px-6 max-w-7xl mx-auto text-center overflow-hidden">
      <div className="absloute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] bg-brand-500/15 blur-[120px] pointer-events-none"></div>
      ...
      <p className="text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed font-normal">
        ...
        stream live telemetry across distributed global environment with zero
        downtime.
      </p>
